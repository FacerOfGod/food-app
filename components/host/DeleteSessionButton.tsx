...
export function DeleteSessionButton({ sessionId, sessionName }: { sessionId: string; sessionName: string }) {
  ...
  function handleDelete(e: React.MouseEvent) {
    e.preventDefault(); // Prevent navigating to the session page
    
    if (window.confirm(`Êtes-vous sûr de vouloir supprimer la session "${sessionName}" et toutes ses données ?`)) {
